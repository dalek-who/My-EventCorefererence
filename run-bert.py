...
args_value = {
    # 会调整的
    "--description": "DAST_within-document_batch-80_epoch-5_sentence-trigger_no-hidden-layer_increase-positive-2_half-window-3_lr-5e--6",
    ...
    "--train_output_dir":
        ...
        "/users/wangyuanzheng/event_coreference/my-ev-coref/middle_data/DAST_model/SentenceTrigger_no-hidden-layer_within-document_increase-positive-2_epoch-5_lr-5e-6_half-window-3",
    "--predict_output_dir":
        # "/users/wangyuanzheng/event_coreference/my-ev-coref/middle_data/DAST_predict/demo",
        "/users/wangyuanzheng/event_coreference/my-ev-coref/middle_data/DAST_predict/SentenceTrigger_no-hidden-layer_within-document_increase-positive-2_epoch-5_lr-5e-6_half-window-3",
