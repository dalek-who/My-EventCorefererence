...
if check_gpus():
    ...
    def query_gpu(qargs:list=None):
        ...
        查询GPU信息
        '''
        qargs = [] if qargs is None else qargs
    ...
    class GPUManager():
        ...
        def __init__(self, qargs:list=None):
            '''
            '''
            qargs = [] if qargs is None else qargs
            self.qargs = qargs
        ...
        def _sort_by_custom(self, gpus, key, reverse=False, qargs:list=None):
            qargs = [] if qargs is None else qargs
