...
script = "main.py"
log_name = "log_run-dast-no-hidden.txt"


args_value = {
    # 会调整的
    "--description": "DAST-ALL_cross-document_epoch-3_no-hidden-layer_increase-positive-3_half-window-3_lr-5e-5",
    ...
    "--train_output_dir":
        ...
        "/users/wangyuanzheng/event_coreference/my-ev-coref/middle_data/DAST_model/DAST_no-hidden-layer_cross-document_increase-positive-3_epoch-3_lr-5e-5_half-window-3",
    "--predict_output_dir":
        # "/users/wangyuanzheng/event_coreference/my-ev-coref/middle_data/DAST_predict/demo",
        "/users/wangyuanzheng/event_coreference/my-ev-coref/middle_data/DAST_predict/DAST_no-hidden-layer_cross-document_increase-positive-3_epoch-3_lr-5e-5_half-window-3",
